...
export default function PricingSection() {
    ...
    return (
        <Section
            ...
            className=""
            background="lg:bg-[url('/images/shades/light.png')] bg-contain bg-no-repeat bg-bottom pb-62"
            parentBackground="lg:bg-[url('/images/shades/spotlight.png')] bg-contain bg-no-repeat bg-top bg-local"
        >
            {/* 
